...
#                                               't_mae': test_metrics['t_mae']})
        ...
        for inputs in dataloader['train']:
            ...
            rpmnet_data = {'points_src':P1_gt,'points_ref':P2_gt}
            gt_transform = inputs["gt_T"].cuda()
            ...
            with torch.set_grad_enabled(True):
                ...
                if iter_num % cfg.STATISTIC_STEP == 0:
                    ...
                    print('Epoch {:<4} Iteration {:<4} {:>4.2f}sample/s Loss={:<8.4f} PermLoss={:<8.4f} GT-Acc:{:.4f} Pred-Acc:{:.4f}'
        ...
        print('Epoch {:<4} Mean-Loss: {:.4f} Mean-PermLoss: {:.4f} GT-Acc:{:.4f} Pred-Acc:{:.4f}'.
              format(epoch, summary_metrics['loss'], summary_metrics['permloss'], summary_metrics['acc_gt'], summary_metrics['acc_pred']) )
        print_metrics(summary_metrics)
    
        model_path = str(checkpoint_path / 'rgm_params_{:04}.pt'.format(epoch + 1))
